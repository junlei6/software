...
BIOBERT_NER_MODEL_DIR = "biobert_ner/output"
BIOBERT_RE_MODEL_DIR = "biobert_re/output"

# =====BioBERT Model for NER======
biobert_ner_labels = get_labels('biobert_ner/dataset/labels.txt')
